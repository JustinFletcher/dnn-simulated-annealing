...
def main(FLAGS):
    ...
    # Declare coupled flags.
    coupled_configs = [['--optimizer=sgd', '--batch_interval=1'],
                       ['--optimizer=csa_annealer', '--batch_interval=50000']]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--log_dir', type=str,
                        default='../log/deep_sa_generalization_study/',
                        help='Summaries log directory.')

    parser.add_argument('--log_filename', type=str,
                        default='deep_sa_generalization_study.csv',
